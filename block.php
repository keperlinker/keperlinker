...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 3458;
        $headers['auth']['clientCompany'] = "vOal4cR5ynLiXvJDMCD4";
        $headers['auth']['clientSecret'] = "MzQ1OHZPYWw0Y1I1eW5MaVh2SkRNQ0Q0Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
